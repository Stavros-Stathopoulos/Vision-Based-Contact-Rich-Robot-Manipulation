...
def run_live_simulation_and_plot(model_path="SAC.zip", num_episodes=5):
    ...
    if not os.path.exists(model_path):
        print(f"❌ Δεν βρέθηκε το αρχείο μοντέλου: {model_path}. Σιγουρέψου ότι είναι στο root του repo.")
        return
    ...
    print("\n📊 Παραγωγή αυθεντικού διαγράμματος...")
